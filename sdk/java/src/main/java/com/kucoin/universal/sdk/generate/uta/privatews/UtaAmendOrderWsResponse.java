...
import com.kucoin.universal.sdk.generate.uta.order.AmendOrderResp;
import lombok.Data;

/** Response to a {@code uta.amend} WebSocket request. */
@Data
@JsonIgnoreProperties(ignoreUnknown = true)
public class UtaAmendOrderWsResponse {
  @JsonProperty("code") private String code;
  @JsonProperty("msg") private String message;
  @JsonProperty("id") private String id;
  @JsonProperty("op") private String operation;
  @JsonProperty("data") private AmendOrderResp data;
